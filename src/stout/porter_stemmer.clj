...
(defn- *o? [s]
  ...
  (let [suffix (s/tail s 3)
        types (get-consonants suffix)]
    (and (= types [true false true])
         (and ((complement #{"w" "x" "y"}) (s/tail suffix 1))))))
